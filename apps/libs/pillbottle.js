...
pillbottle.newDosage = function(pillBottleId, description, pill, duration, dosage, callback) {
    var qry = "UPDATE pillbottle SET pill = ?, description = ?, course = course +1, duration = ? WHERE id = ?";
    // connection.on('error', function(err) {
